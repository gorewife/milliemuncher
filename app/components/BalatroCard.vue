      ...
      <div v-if="hovered" class="tooltip">
        <slot>
          ...
          <p class="tooltip-desc">
            This joker gains +1 Mult and +15 Chips every time they/them pronouns
            are used correctly. 1 out of 1000 chance to fall asleep.
          </p>
          <p class="tooltip-flavour">"they're kinda gay and filipino"</p>
        </slot>
      </div>
    </Transition>
  </div>
